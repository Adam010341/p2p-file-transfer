sequenceDiagram
    participant CLI as CLI<br/>(Member C: UI & Adapter Layer)
    participant SendFileUseCase as SendFileUseCase<br/>(Member B: Core Domain & Brain)
    participant NettyGateway as NettyGateway<br/>(Member A: Network Infrastructure)
